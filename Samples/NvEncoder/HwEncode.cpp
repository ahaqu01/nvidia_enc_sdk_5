...
#endif
encodeConfig.outputFileName = "output0000.avi";
   for(int count = 0; count<10000;count++)
	{
...
#if 0
int CNvEncoder::MyYuvToH264(Mat yuvFrame, int width, int height, bool firstFrame, bool endFrame)
{
	if(yuvFrame.empty())
	{
		printf("yuvFrame is null!\n")
		return 0;
	}
